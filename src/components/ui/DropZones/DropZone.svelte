...
<script lang="ts">
  ...
  let {
    ...
    dragAndDropIcon = "pixelarticons:drag-and-drop",
...
>
  ...
  <form onsubmit={preventDefault(handleUpload)} enctype="multipart/form-data">
    ...
    <div class="drag-drop-text-container">
      {#if children}{@render children()}{:else}Or Drag &amp; Drop Files Here{/if}
    </div>
      ...
      <div class="upload-files-container">
        ...
        {#each [...formData.entries()] as file (file[0])}
          <div class="staged-file-container">
            ...
            <button class="remove-file-btn" onclick={() => removeFile(file[0])} disabled={uploading}>
